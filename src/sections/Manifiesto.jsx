...
const Manifiesto = () => {
  ...
  const nextPage = () => {
    if (currentPage < manifiestoTexto.length - 1) setCurrentPage(currentPage + 1);
  };
    ...
    <section id="manifiesto" className="manifiesto">
      ...
      <div className="manifiesto-content-wrapper">
        ...
        <div className="manifiesto-contenido">
          <span className="manifiesto-comilla" aria-hidden="true">"</span>
          <p key={currentPage} className="manifiesto-texto">
            {manifiestoTexto[currentPage]}
          </p>
          <div className="manifiesto-navegacion">
            <button
              className="manifiesto-arrow"
              onClick={prevPage}
            ...
            <div className="manifiesto-dots">
              {manifiestoTexto.map((_, i) => (
                <button
                  key={i}
                  className={`manifiesto-dot${i === currentPage ? " dot-activo" : ""}`}
